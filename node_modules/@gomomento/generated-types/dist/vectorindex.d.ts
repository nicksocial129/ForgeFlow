...
export declare namespace vectorindex {
    ...
    export class _FilterExpression extends pb_1.Message {
        ...
        get expression(): "none" | "equals_expression" | "and_expression" | "or_expression" | "not_expression" | "greater_than_expression" | "greater_than_or_equal_expression" | "less_than_expression" | "less_than_or_equal_expression" | "list_contains_expression";
        static fromObject(data: {
    ...
    export class _SearchRequest extends pb_1.Message {
        ...
        get filter_expression(): _FilterExpression;
        set filter_expression(value: _FilterExpression);
        get has_filter_expression(): boolean;
        ...
        static fromObject(data: {
            ...
            filter_expression?: ReturnType<typeof _FilterExpression.prototype.toObject>;
        }): _SearchRequest;
        toObject(): {
            index_name?: string;
            top_k?: number;

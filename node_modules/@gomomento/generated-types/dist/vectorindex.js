...
(function (vectorindex) {
    ...
    class _FilterExpression extends pb_1.Message {
        constructor(data) {
            super();
            __FilterExpression_one_of_decls.set(this, [[1, 2, 3, 4, 5, 6, 7, 8, 9]]);
    ...
    class _SearchRequest extends pb_1.Message {
        constructor(data) {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("filter_expression" in data && data.filter_expression != undefined) {
        ...
        set filter_expression(value) {
            pb_1.Message.setWrapperField(this, 7, value);
        }
        get has_filter_expression() {
            return pb_1.Message.getField(this, 7) != null;
        }
        get threshold() {
            const cases = {
        ...
        static fromObject(data) {
            ...
            if (data.filter_expression != null) {
                message.filter_expression = _FilterExpression.fromObject(data.filter_expression);
            }
            return message;
        }
        toObject() {
            ...
            if (this.filter_expression != null) {
                data.filter_expression = this.filter_expression.toObject();
            }
            return data;
        }
        serialize(w) {
            ...
            if (this.has_filter_expression)
                writer.writeMessage(7, this.filter_expression, () => this.filter_expression.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        reader.readMessage(message.filter_expression, () => message.filter_expression = _FilterExpression.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    class _ItemMetadataResponse extends pb_1.Message {
        constructor(data) {
            ...
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, __ItemMetadataResponse_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
    ...
    class _ItemResponse extends pb_1.Message {
        constructor(data) {
            ...
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, __ItemResponse_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("miss" in data && data.miss != undefined) {
                    this.miss = data.miss;
                }

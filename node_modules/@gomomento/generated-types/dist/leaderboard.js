...
(function (leaderboard) {
    ...
    class _Element extends pb_1.Message {
        constructor(data) {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("score_f32" in data && data.score_f32 != undefined) {
                    this.score_f32 = data.score_f32;
                }
        ...
        static fromObject(data) {
            ...
            if (data.score_f32 != null) {
                message.score_f32 = data.score_f32;
            }
            if (data.score != null) {
        ...
        toObject() {
            ...
            if (this.score_f32 != null) {
                data.score_f32 = this.score_f32;
            }
            if (this.score != null) {
        ...
        serialize(w) {
            ...
            if (this.score_f32 != 0)
                writer.writeFloat(2, this.score_f32);
            if (this.score != 0)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        message.score_f32 = reader.readFloat();
                        break;
                    case 3:
    ...
    class _ScoreRange extends pb_1.Message {
        constructor(data) {
            super();
            __ScoreRange_one_of_decls.set(this, [[1, 2, 5], [3, 4, 6]]);
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("min_inclusive_f32" in data && data.min_inclusive_f32 != undefined) {
                    this.min_inclusive_f32 = data.min_inclusive_f32;
                }
                ...
                if ("max_exclusive_f32" in data && data.max_exclusive_f32 != undefined) {
                    this.max_exclusive_f32 = data.max_exclusive_f32;
                }
        ...
        /** @deprecated*/
        get min_inclusive_f32() {
            return pb_1.Message.getFieldWithDefault(this, 2, 0);
        }
        /** @deprecated*/
        set min_inclusive_f32(value) {
            pb_1.Message.setOneofField(this, 2, __classPrivateFieldGet(this, __ScoreRange_one_of_decls, "f")[0], value);
        }
        /** @deprecated*/
        get has_min_inclusive_f32() {
        ...
        /** @deprecated*/
        get max_exclusive_f32() {
            return pb_1.Message.getFieldWithDefault(this, 4, 0);
        }
        /** @deprecated*/
        set max_exclusive_f32(value) {
            pb_1.Message.setOneofField(this, 4, __classPrivateFieldGet(this, __ScoreRange_one_of_decls, "f")[1], value);
        }
        /** @deprecated*/
        get has_max_exclusive_f32() {
        ...
        get min() {
            ...
            return cases[pb_1.Message.computeOneofCase(this, [1, 2, 5])];
        }
        get max() {
            const cases = {
                0: "none",
            ...
            return cases[pb_1.Message.computeOneofCase(this, [3, 4, 6])];
        }
        static fromObject(data) {
            ...
            if (data.min_inclusive_f32 != null) {
                message.min_inclusive_f32 = data.min_inclusive_f32;
            }
            ...
            if (data.max_exclusive_f32 != null) {
                message.max_exclusive_f32 = data.max_exclusive_f32;
            }
        ...
        toObject() {
            ...
            if (this.min_inclusive_f32 != null) {
                data.min_inclusive_f32 = this.min_inclusive_f32;
            }
            ...
            if (this.max_exclusive_f32 != null) {
                data.max_exclusive_f32 = this.max_exclusive_f32;
            }
        ...
        serialize(w) {
            ...
            if (this.has_min_inclusive_f32)
                writer.writeFloat(2, this.min_inclusive_f32);
            ...
            if (this.has_max_exclusive_f32)
                writer.writeFloat(4, this.max_exclusive_f32);
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        message.min_inclusive_f32 = reader.readFloat();
                        break;
                    case 5:
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        message.max_exclusive_f32 = reader.readFloat();
                        break;
                    case 6:

...
export { StaticGrpcConfiguration, StaticTransportStrategy, TransportStrategy, TransportStrategyProps, } from './config/transport/transport-strategy';
export { GrpcConfiguration, GrpcConfigurationProps, } from './config/transport/grpc-configuration';
...
export { ICacheClient, IMomentoCache, CollectionTtl, ItemType, SortedSetOrder, Configurations, Configuration, CacheConfiguration, PreviewVectorIndexClient, VectorIndexConfigurations, VectorIndexConfiguration, CacheClient, SimpleCacheClient, CacheInfo, VectorIndexInfo, CredentialProvider, StringMomentoTokenProvider, EnvMomentoTokenProvider, CacheRole, CachePermission, TopicRole, TopicPermission, Permission, Permissions, AllDataReadWrite, PermissionScope, 
/**
 * @deprecated please use 'PermissionScope' instead
 */

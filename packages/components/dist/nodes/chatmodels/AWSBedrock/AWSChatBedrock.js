...
const bedrock_1 = require("langchain/chat_models/bedrock");
/**
...
class AWSChatBedrock_ChatModels {
    constructor() {
        ...
        this.baseClasses = [this.type, ...(0, utils_1.getBaseClasses)(bedrock_1.BedrockChat)];
        this.credential = {
    ...
    async init(nodeData, _, options) {
        ...
        if (cache)
            obj.cache = cache;
        const amazonBedrock = new bedrock_1.BedrockChat(obj);

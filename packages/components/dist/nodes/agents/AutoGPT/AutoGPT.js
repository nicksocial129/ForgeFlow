        ...
        try {
            ...
            executor.run = async (goals) => {
                ...
                while (loopCount < executor.maxIterations) {
                    ...
                    executor.fullMessageHistory.push(new schema_1.HumanMessage(user_input));
                    executor.fullMessageHistory.push(new schema_1.AIMessage(assistantReply));
                    ...
                    executor.fullMessageHistory.push(new schema_1.SystemMessage(result));
                }
                return undefined;
            };

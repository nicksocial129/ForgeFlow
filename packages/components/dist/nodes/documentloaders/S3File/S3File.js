...
class S3_DocumentLoaders {
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                description: 'Only load documents with NarrativeText metadata from Unstructured. See how Unstructured partition data <a target="_blank" href="https://unstructured-io.github.io/unstructured/bricks/partition.html#">here</a>',
                default: true,
                type: 'boolean',
                optional: true,
    ...
    async init(nodeData, _, options) {
        ...
        const narrativeTextOnly = nodeData.inputs?.narrativeTextOnly;
